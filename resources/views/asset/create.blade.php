                    ...
                    <div class="Polaris-Modal-Dialog__Modal">
                        <div class="Polaris-Modal-Header">
                            <div id="Polarismodal-header2" class="Polaris-Modal-Header__Title">
                                <h2 class="Polaris-DisplayText Polaris-DisplayText--sizeSmall">New Asset</h2>
                            </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="Polaris-Select">
                                                ...
                                                <div class="Polaris-Select__Content" aria-hidden="true">
                                                    <span class="Polaris-Select__SelectedOption" id="title">Select Your Theme</span>
                                                </div>
...
@push('page_script')
    <script>
        $('#create').on('click',function(event){
            $("#createAssetsModal").show();
        });

        $('#modalClose').on('click',function(event){
            $("#createAssetsModal").hide();
        });
        ...
        $(document).on('change','#themesDropDown',function (e) {
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    {
                        const toastOptions = {
                            message: 'Asset successfully created in your theme...',
                            duration: 5000,
                        };
